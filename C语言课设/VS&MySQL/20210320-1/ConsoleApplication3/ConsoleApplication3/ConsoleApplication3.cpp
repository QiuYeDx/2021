...
//数据备份
bool backup() {
	char zl1[300] = "select * from goods_v1.goods INTO OUTFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\backup.sql'";
	char zl2[300] = "LOAD DATA LOCAL INFILE 'dump.txt' INTO TABLE mytbl;";
}
bool recover() {
