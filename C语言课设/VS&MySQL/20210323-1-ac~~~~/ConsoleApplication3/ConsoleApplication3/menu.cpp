...
void head_info(int i)
{
	...
	switch(i)
	{
	case 1:printf("\t\t\t%-15s", "主菜单         "); break;
	case 2:printf("\t\t\t%-15s", "主菜单->管理员工账号"); break;
	case 3:printf("\t\t\t%-15s", "主菜单->账目"); break;
	case 4:printf("\t\t\t%-15s", "主菜单->会员系统"); break;
	case 5:printf("\t\t\t%-15s", "主菜单->商品数据管理"); break;
	case 6:printf("\t\t\t%-15s", "主菜单->结账"); break;
	case 7:printf("\t\t\t%-15s", "主菜单->修改个人信息"); break;
