...
QT_MOC_LITERAL(1, 10, 10), // "sendreshow"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 9) // "pausegame"

    },
    "MainScene\0sendreshow\0\0pausegame"
};
...
void MainScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainScene::sendreshow)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainScene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainScene::pausegame)) {
                *result = 1;
                return;
            }
        }
